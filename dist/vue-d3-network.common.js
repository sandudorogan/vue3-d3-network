...
const _hoisted_3 = ["id", "d", "onClick", "onTouchstartPassive"]
const _hoisted_4 = {
  key: 0,
  id: "l-nodes",
  class: "nodes"
}
const _hoisted_5 = ["viewBox", "width", "height", "x", "y", "title", "onClick", "onTouchendPassive", "onMousedown", "onTouchstart", "innerHTML"]
const _hoisted_6 = ["r", "cx", "cy", "title", "onClick", "onTouchendPassive", "onMousedown", "onTouchstart"]
const _hoisted_7 = {
  key: 1,
  id: "link-labels",
  class: "labels"
  ...
  return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("svg", {
    ...
    (!_ctx.noNodes)
      ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("g", _hoisted_4, [
          ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.renderList)(_ctx.nodes, (node, key) => {
            return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.Fragment, { key: key }, [
              (_ctx.svgIcon(node))
                ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("svg", (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.mergeProps)({
                    ...
                    onMousedown: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withModifiers)($event => (_ctx.emit('dragStart',[$event,key])), ["prevent"]),
                    onTouchstart: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withModifiers)($event => (_ctx.emit('dragStart',[$event,key])), ["prevent"]),
...
/* harmony default export */ var svgRenderervue_type_script_lang_js = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  name: 'SvgRenderer',
  emits: ['action'],
  props: [
    'size',
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/canvasRenderer.vue?vue&type=template&id=472698e0


const canvasRenderervue_type_template_id_472698e0_hoisted_1 = ["width", "height"]

function canvasRenderervue_type_template_id_472698e0_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withDirectives)(((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("canvas", {
    ...
    width: _ctx.size.w,
    height: _ctx.size.h,
    style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.normalizeStyle)(_ctx.canvasStyle),
    onMouseup: _cache[0] || (_cache[0] = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withModifiers)((...args) => (_ctx.canvasClick && _ctx.canvasClick(...args)), ["prevent"])),
    onMousedown: _cache[1] || (_cache[1] = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withModifiers)((...args) => (_ctx.canvasClick && _ctx.canvasClick(...args)), ["prevent"])),
    onTouchstart: _cache[2] || (_cache[2] = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withModifiers)((...args) => (_ctx.canvasClick && _ctx.canvasClick(...args)), ["prevent"])),
    onTouchendPassive: _cache[3] || (_cache[3] = (...args) => (_ctx.canvasClick && _ctx.canvasClick(...args)))
  }, null, 44, canvasRenderervue_type_template_id_472698e0_hoisted_1)), [
    [_directive_render_canvas, {links: _ctx.links, nodes: _ctx.nodes}]
  ])
}
;// CONCATENATED MODULE: ./src/components/canvasRenderer.vue?vue&type=template&id=472698e0
...
/* harmony default export */ var canvasRenderervue_type_script_lang_js = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  name: 'CanvasRenderer',
  directives: {
    renderCanvas: {
...
const canvasRenderer_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(canvasRenderervue_type_script_lang_js, [['render',canvasRenderervue_type_template_id_472698e0_render]])
...
/* harmony default export */ var vue_d3_networkvue_type_script_lang_js = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  name: 'D3Network',
  components: {
...
;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-39.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-39.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-39.use[2]!./node_modules/stylus-loader/index.js??clonedRuleSet-39.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/vue-d3-network.vue?vue&type=style&index=0&id=5b823922&lang=stylus
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/vue-d3-network.vue?vue&type=style&index=0&id=5b823922&lang=stylus
